...
adapter and message catalogs) into an adopter's repository, referencing `@roonga/qcms-core`,
`@roonga/qcms-a2ui-compiler`, `@roonga/qcms-db`, `@roonga/qcms-ui`, `@roonga/qcms-observability` and `@roonga/qcms-csv`
