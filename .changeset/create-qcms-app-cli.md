...
`@qcms/a2ui-compiler`, `@qcms/db` and `@qcms/ui` by version. It prompts for the
project name, package manager, deployment shape (solo or enterprise), admin 2FA
policy and the portal and admin base URLs, and takes every default under `--yes` for
