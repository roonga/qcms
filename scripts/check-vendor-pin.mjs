 ...
 *      better-auth package name: `better-auth 1.7.5`, `better-auth@1.7.5`,
 *      `@better-auth/core 1.7.5`, `@better-auth/core@1.7.5`.
 ...
 *     less than a gate with a documented gap. Write "better-auth 1.7.5" rather than
 *     "the pinned 1.7.5" and the claim is covered.
 ...
 * `snapshots:`. A scoped name is quoted there (`'@better-auth/core@1.7.5':`), a bare
 * one is not (`better-auth@1.7.5:`), and a snapshot key carries a peer suffix in
