...
`1935` lines across `332` scaffolded files cite a QCMS issue, ADR, SEC control, plan task or repository path.
...
apps/admin/components/menu-slots.ts
...
apps/api/src/features/auth/reset-two-factor.ts
...
apps/api/src/reset-2fa-args.ts
apps/api/src/reset-2fa.ts
