...
**Status:** Signed off: Code Owner, 2026-07-21 · **Consumed by:** 041 · **Renders:** `POST /admin/forms/:id/draft/assist` (a 041 route, SSE; flag-gated and **not part of the frozen 027 core contract**) · visible only when `QCMS_FLAG_AGENT_AUTHORING` ≠ `none`
