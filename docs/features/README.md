...
| 051 | Theming A: 4-group token contract + predefined themes (L/D) + HC mode layer + per-deployment selection via config (047 EC 1-2) | 7 | todo (after 045; first of the 047 slices) |
