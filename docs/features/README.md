...
| 040 | Security review and hardening (runs after 036, before 038) | 8b | in review (PR #495) - review doc (`docs/security-review-2026-08-14.md`), the SEC-3.2 matrix suite and the hardening landed; exit criteria 3 and 4 still open, on #390 (Code Owner ruling) and #360 (provenance) - #470 closed in the base `fbc674f`; Code Owner sign-off outstanding. **Not `todo`**: the tree already carries this work, and the branch claim dies when the branch is deleted at merge |
