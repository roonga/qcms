...
| 047 | Portal theming: managed themes + respondent controls (mode/font/density) + declarative font registry + 4-group token contract (color/type/spacing/radius), ADR-30 - launch tier (admin theme editor split out to 049 per the 2026-07-25 amendment) | 7 | done (decomposed 2026-07-27 into 051 -> 052 -> 053; all three landed - PR #190, #194, #TBD) |
