...
| 053 | Theming C: respondent mode/font/density controls + persistence + SSR no-flash + brand mark from config (047 EC 3, 5-7; folds #25; UI screenshot gate) | 7 | in-progress (feat/053-theming-respondent-controls) |
