...
| 046 | Dev container as the canonical dev environment (Ubuntu 24.04; bypassPermissions loop; ADR-29) - off the launch gate; dispatch manually via `/task 046` after 045, not auto-selected | 7 | in-progress (feat/046-devcontainer) |
