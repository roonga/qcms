...
**Implementation note (2026-07-26, issue #95 / task 050; pending Code Owner confirmation at the gate).** The shape the decision took, recorded because one line of the Consequences above predicted otherwise:
