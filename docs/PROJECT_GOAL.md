...
| date | on completion, committed when editing ends (all-segments-filled precondition; a partial date never posts) *(amended 2026-07-26)* | yes, at the commit |
| number | on blur | yes |
