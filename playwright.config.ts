...
export default defineConfig({
  ...
  // run has UNEXPECTED failures (issues #395, #828): which other seats' harness ports
  // were live, what the host load and the shared Docker daemon were carrying, and which
