...
export default async function QuestionDetailPage({
  ...
  return (
    ...
    // as this route's cap on `<main>` instead, which rendered 680 - the drawn number minus
    // the column's own padding, which the drawn element sits INSIDE rather than outside.
