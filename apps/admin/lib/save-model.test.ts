...
const SCREENS: readonly ScreenRow[] = [
  ...
  // The seven `@rail` entries below are parallel-route slots rather than screens (issue
  ...
  // as a screen would. All seven answer the same way, and that is the contract rather than
