...
- [Filesystem scope boundary](filesystem-scope-boundary.md) — never read/edit local folders outside the agent3 tree (H:\source\agent3 on Windows, ~/src/agent3 on WSL2)
