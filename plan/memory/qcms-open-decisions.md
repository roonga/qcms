...
Also open (from Stage 6 audit): issue #5 (@qcms/db enum-row types) - spec'd, scheduled 030→031 via executor+reviewer. Harness Write-guard blocks task-declared doc/changeset deliverables - flagged to the Code Owner, harness-config level.
