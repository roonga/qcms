...
const hcPairs = [
  ...
  [
    `secondary-fg / secondary (AAA)`,
    hc["--color-secondary-foreground"],
    hc["--color-secondary"],
    7.0,
  ],
  ...
  [
    `success-fg / success-subtle (AAA)`,
    hc["--color-success-fg"],
    hc["--color-success-subtle"],
    7.0,
  ],
  [
    `warning-fg / warning-subtle (AAA)`,
    hc["--color-warning-fg"],
    hc["--color-warning-subtle"],
    7.0,
  ],
