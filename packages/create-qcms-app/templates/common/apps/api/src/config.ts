...
export interface Config {
  ...
  readonly adminAuth: {
     ...
     *
     * Passed to better-auth as `secret`, which in the pinned better-auth 1.7.5 means
     ...
     * whether it ran: better-auth 1.7.5 resolves `enabled` as
...
const DEFAULTS = {
  ...
  // 30d, from @roonga/qcms-db - same split, the rationale lives with the sweep (#329).
