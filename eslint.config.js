...
export default tseslint.config(
  ...
  },
  {
    ...
    // consuming `@roonga/qcms-ui/kit`: nothing stopped a screen adding a widget library as a
    // direct dependency and importing it. This is the fast fence; the exhaustive
    // allow-list assertion stays in @roonga/qcms-ui's import-surface test, which is where the
          ...
          patterns: [
            {
              group: competingComponentLibraries,
              message:
                "Both frontends build only on the a2-react-aria stack (ADR-22): render through @roonga/qcms-ui/kit or react-aria-components - never a second component library.",
            },
          ],
        },
      ],
